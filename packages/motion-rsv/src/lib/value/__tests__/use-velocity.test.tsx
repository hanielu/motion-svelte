	...
	test("creates a motion value that updates with the velocity of the provided motion value", async () => {
		...
		const promise = new Promise((resolve) => {
			const Component = () => {
				...
				useMotionValueEvent(x, "change", (v) => output.push(Math.round(v)));
		...
		await promise;
		expect(output).toEqual([20, 80, 180, 320, 500, 680, 820, 920, 980, 1000]);
		expect(outputVelocity).toEqual([2000, 6000, 10000, 14000, 18000, 18000, 14000, 10000, 6000, 2000, 0]);
		expect([outputAcceleration[0], outputAcceleration[1], outputAcceleration[2]]).toEqual([200000, 400000, 400000]);
	});
});
