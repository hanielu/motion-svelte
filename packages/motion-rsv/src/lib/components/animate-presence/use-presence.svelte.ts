...
export function usePresence(
	...
	const parentPresenceContext = PresenceContext.getOr();
	...
	const safeToRemove: SafeToRemove | undefined = !subscribe || !onExitComplete ? undefined : () => onExitComplete(id);
...
export function useIsPresent() {
	const parentContext = PresenceContext.getOr();
