import type { Edge, Intersection, ProgressIntersection } from "@/types/index.js";
...
function matchesPreset(offset: ScrollOffsetType, preset: readonly (readonly [number, number])[]): boolean {
