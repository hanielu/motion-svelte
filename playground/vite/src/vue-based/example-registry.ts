...
import Gallery from "./examples/animate-presence/enis-repro/gallery.svelte";
...
export const examples: Example[] = [
	...
	{ id: "enis-repro-gallery", name: "Enis Repro Gallery", component: Gallery, category: "Animate Presence" },
	...
	{
		id: "progress-center-reveal",
		name: "Progress Center Reveal",
		component: ProgressCenterReveal,
		category: "Variants",
	},
	...
	{
		id: "use-transform-path-morphing",
		name: "Use Transform Path Morphing",
		component: UseTransformPathMorphing,
		category: "From Docs",
	},
	{
		id: "drag-direction-locking",
		name: "Drag Direction Locking",
		component: DragDirectionLocking,
		category: "From Docs",
	},
...
export const examplesByCategory = examples.reduce(
	(acc, example) => {
...
export const examplesById = examples.reduce(
	(acc, example) => {
