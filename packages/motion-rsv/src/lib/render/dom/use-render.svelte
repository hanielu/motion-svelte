...
>
	...
	let { Component, props, ref, latestValues, isStatic, forwardMotionProps = false }: UseRenderProps = $props();
	...
	const presenceBox = PresenceContext.getOr(); // PresenceContextProps | null
