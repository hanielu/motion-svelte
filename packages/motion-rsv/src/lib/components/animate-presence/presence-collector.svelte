<script lang="ts" module>
	...
	export const PresenceCollectorContext = new Context<PresenceCollector | null>("PresenceCollectorContext", null);
</script>
...
<script lang="ts">
	...
	if (process.env.NODE_ENV !== "production") {
		warning(key != null, "AnimatePresence", "Missing `key` on motion element inside <AnimatePresence>.");
	}
