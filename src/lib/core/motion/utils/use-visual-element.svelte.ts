import { LazyContext } from "$lib/core/context/lazy-context.js";
import { MotionConfigContext } from "$lib/core/context/motion-config-context.js";
import { MotionContext } from "$lib/core/context/motion-context/index.js";
import { PresenceContext } from "$lib/core/context/presence-context.js";
import {
  SwitchLayoutGroupContext,
  type InitialPromotionConfig,
} from "$lib/core/context/switch-layout-group-context.js";
import type { IProjectionNode } from "$lib/core/projection/node/types.js";
import type { DOMMotionComponents } from "$lib/core/render/dom/types.js";
import type { HTMLRenderState } from "$lib/core/render/html/types.js";
import type { SVGRenderState } from "$lib/core/render/svg/types.js";
...
>(
   ...
   */
  createVisualElement =
    createVisualElement || (lazyContext.renderer as unknown as CreateVisualElement<Props, TagName>);
  ...
  const optimisedAppearId =
    props.current[optimizedAppearDataAttribute as keyof typeof props.current];
  let wantsHandoff =
...
function needsContinuousMeasurement(
  ...
  if (
    ...
    ("left" in dragConstraints ||
      "right" in dragConstraints ||
      "top" in dragConstraints ||
      "bottom" in dragConstraints)
  ) {
