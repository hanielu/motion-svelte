...
function handlePressEvent(node: VisualElement<Element>, event: PointerEvent, lifecycle: "Start" | "End" | "Cancel") {
	const { props } = node;
	...
	const eventName = ("onTap" + (lifecycle === "End" ? "" : lifecycle)) as "onTapStart" | "onTap" | "onTapCancel";
